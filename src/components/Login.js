...
function Login({ handleLogin }) {
    ...
    return (
        <div className="authorize">
            ...
            <form onSubmit={handleSubmit} className="authorize__form" noValidate>
                ...
                <input onChange={handleDataUser} id="passwordAuthorize" type="text" value={formvalue.password} className="authorize__input authorize__input_password" name="password" placeholder="Пароль" required minLength="2" maxLength="40" />
